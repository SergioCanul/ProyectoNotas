...
<div class="w-full max-w-xs mx-auto">
  <form action="{{route('cornellnote.store')}}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ">
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="ideas" name="ideas" type="text" placeholder="ier.123">
    ...
    <div class="mb-2">
      ...
      <input class="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="notas" name="notas" type="text" placeholder="Esta seccion...">
    </div>
    <div class="mb-2">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="resumen">
        Resumen:
      </label>
      <textarea class="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="resumen" name="resumen" type="text" placeholder="Para empezar..."></textarea>
    </div>
    <div class="mb-2">
